...
class display_airchange(ctk.CTkFrame):
    def __init__(self, parent, new_data_var, page_menu_var, path_var, airch_dayprofile_var):
        ...
        # label
        ctk.CTkLabel(self, text = "airch", font = title_font).grid(row = 0, column = 0, sticky = "nsew", padx = STANDARD_PADX, pady = STANDARD_PADY)
