...
class display_relhumid(ctk.CTkFrame):
    def __init__(self, parent, new_data_var, page_menu_var, path_var, rh_dayprofile_var):
        ...
        if path == "":
            ...
            df = discard_data(import_data_dayprofile(path, dayprofile), "RelHumid")
