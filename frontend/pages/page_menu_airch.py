...
class page_menu_airch(ctk.CTkFrame):
    def __init__(self, parent, airch_dayprofile_var, airch_maxairch_one_var, airch_maxairch_two_var, airch_maxairch_three_var, airch_formatcolor_one_var, airch_formatcolor_two_var, airch_formatcolor_three_var):
